...
const SpellList = () => {
  ...
  const handleToggleFavorite = (spell) => {
    const isFavorite = favorites.some(fav => fav.index === spell.index);
    const updatedFavorites = isFavorite
      ? favorites.filter(fav => fav.index !== spell.index)
      : [...favorites, spell];
  ...
  return (
    <div className="spell-container">
      ...
      <p className="total-count">Total de magias filtradas: {filteredSpells.length}</p>
          ...
          filteredSpells.map(spell => {
            ...
            return (
              <div key={spell.index} className="spell-card">
                <Link to={`/spell/${spell.index}`} className="spell-link">
